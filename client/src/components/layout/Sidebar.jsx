...
function useNavItems(persona, t) {
  return useMemo(() => {
    const citizen = [
      ...
      { icon: IC.consultations, label: t('sidebar.myConsultations', 'My Consultations'), path: '/citizen/consultations' },
    ...
    const admin = [
      ...
      { icon: IC.earnings,      label: t('sidebar.withdrawals',     'Withdrawals'),     path: '/admin/withdrawals' },
