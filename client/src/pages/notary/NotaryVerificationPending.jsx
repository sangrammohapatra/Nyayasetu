...
import { selectNotaryProfile, logout } from '../../store/slices/authSlice';
...
const STATUS_META = {
  pending: {
    ...
    body: 'Our team is verifying your notary credentials. This usually takes 1–2 business days. You will receive an email and WhatsApp notification once your profile is approved.',
  },
  under_review: {
    icon: '🔍',
    label: 'Under Review',
        ...
        >
          ...
          <Box sx={{ textAlign: 'left', mb: 3 }}>
            ...
            <Box component="ul" sx={{ m: 0, mt: 1, pl: 2.5, color: 'var(--color-text-secondary)' }}>
              ...
              <Box component="li" sx={{ mb: 0.5 }}>
                <Typography variant="body2">Ensure your Notary Registration Number is accurate</Typography>
              </Box>
              <Box component="li">
